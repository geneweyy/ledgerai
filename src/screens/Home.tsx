...
export const Home: React.FC = () => {
  ...
  return (
    <div className="screen">
      ...
      <div className="page">
        <div className="card">
          <p className="muted" style={{ margin: 0, fontWeight: 700, color: "var(--ink)" }}>
            {t(lang, "didIMakeMoney")}
          </p>
          <div style={{ fontSize: 34, fontWeight: 800, marginTop: 6, color: net >= 0 ? "var(--teal)" : "var(--red)" }}>
            {formatRM(net)}
          </div>
        ...
        >
          {limitReached ? "⛔" : "✅"} {todaysEntries.length} / {dailyLimit === Infinity ? "∞" : dailyLimit} {t(lang, "entriesUsed")}
